...
const socialLinks = [
  { label: 'Instagram', href: cfg.social.instagram.href, icon: (
  ...
  { label: 'YouTube', href: cfg.social.youtube.href, icon: (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  { label: 'Facebook', href: cfg.social.facebook.href, icon: (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div style={{ width: '100%', padding: '0 clamp(24px, 5vw, 80px)', boxSizing: 'border-box', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{
          ...
          <p style={{ fontSize: '0.72rem', color: 'var(--text)', opacity: 0.5, margin: 0 }}>
            © {year} {cfg.footer?.copyright ?? cfg.personal.name}. All rights reserved.
          </p>
