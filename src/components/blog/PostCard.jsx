...
export default function PostCard({ slug, frontmatter }) {
  ...
  return (
    <div
      ref={cardRef}
      style={{ height: 280, cursor: 'pointer', perspective: '1000px' }}
      onClick={flip}
    ...
    >
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h3 style={{ margin: 0, fontSize: '1rem', fontWeight: 700, color: 'var(--text-h)', textAlign: 'center', lineHeight: 1.35, position: 'relative' }}>
            {title}
          </h3>
          ...
          <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
            {tags.map(tag => (
              <span key={tag} style={{
                ...
                borderRadius: 999, background: 'rgba(255,255,255,0.25)', color: '#fff',
              }}>{tag}</span>
            ))}
          </div>
          <p style={{
