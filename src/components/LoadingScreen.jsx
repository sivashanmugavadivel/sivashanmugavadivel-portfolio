...
const FS_MB = 'clamp(2rem, 10vw, 3rem)'
      ...
      {isVisible && (
        <div style={{ position: 'fixed', inset: 0, zIndex: 9999, pointerEvents: 'all' }}>
          ...
          <div className="ls-desktop">
            ...
            {/* ROW 1 — "Journey" left-aligned from seam */}
            <motion.div
            ...
            {/* ROW 2 — "Begins" right-aligned to seam */}
            <motion.div
          ...
          <div className="ls-mobile">
            ...
            >
              <span style={{
                fontFamily: 'var(--heading)', fontSize: FS_MB,
                fontWeight: 700, fontStyle: 'italic',
                color: 'var(--accent)',
                lineHeight: 1.2, letterSpacing: '-0.02em',
              }}>Journey</span>
